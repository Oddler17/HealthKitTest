//
//  SaveDataPublisher.swift
//  HealthKitTest
//
//  Created by Arseniy Oddler on 4/7/21.
//
...
struct CoreDataSaveDataPublisher: Publisher {
...
extension CoreDataSaveDataPublisher {
...
extension CoreDataSaveDataPublisher.Subscription: Subscription {
...
extension CoreDataSaveDataPublisher.Subscription: Cancellable {
    func cancel() {
        subscriber = nil
    }
}
